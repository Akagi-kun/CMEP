...
#pragma region Public
		...
		: InstanceOwned(with_instance), HoldsVMA(with_instance->GetGraphicMemoryAllocator())
	{
		...
		// Fragment stage
		auto frag_shader_module = ShaderModule(logical_device, shader_path, std::string(settings.shader) + "_frag.spv");
		vk::PipelineShaderStageCreateInfo
		...
		vk::GraphicsPipelineCreateInfo pipeline_info(
			...
			PipelineSettings::GetMultisamplingSettings(instance->GetMSAASamples()),
