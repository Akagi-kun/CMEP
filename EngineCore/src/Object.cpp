...
namespace Engine
{
		...
		glm::vec3 Object::position() const noexcept { return this->_pos; }
		glm::vec3 Object::size() const noexcept { return this->_size; }
		glm::vec3 Object::rotation() const noexcept { return this->_rotation; }
